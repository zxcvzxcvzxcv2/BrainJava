...
import chap19.TestFrm;
 
public class login extends JFrame { 
	    private Main main;
	    private Test testFrm;
	    ...
	    public void placeLoginPanel(JPanel panel){
	        ...
	        btnLogin.setBounds(100, 80, 75, 25);
	        panel.add(btnLogin);
	        ...
	        btnsign = new JButton("sing up");
	        btnsign.setBounds(190, 80, 75, 25);
	        panel.add(btnsign);
	    ...
	    public void isLoginCheck(String id, String pass){
	    	...
	    	String idCheckQuery = "SELECT id, pass FROM login where id = '" + id + "'";
	    	...
	    	if(rs.next()) {
	    		...
	    		if(pass.equals(rs.getString("pass"))) { // 패스워드 비교해서 같다면 pass
	    			//로그인 성공
